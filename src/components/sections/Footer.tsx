...
function Footer() {
  ...
  return (
    <footer className="bg-navy text-white/80">
      <div className="container-page px-3 py-16 grid gap-10 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-5 text-sm leading-relaxed text-white/65">
            Kantor Notaris & PPAT yang menyediakan layanan hukum profesional,
            aman, dan sesuai peraturan yang berlaku — untuk individu maupun
            korporasi.
          </p>
        </div>

        <div>
          <h4 className="text-white font-display text-sm font-semibold mb-4">
            Navigasi
          </h4>
