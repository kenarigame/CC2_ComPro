...
const categories = ["Semua", "Kantor", "Meeting", "Pelayanan", "Penandatanganan"];
          ...
          {filtered.map((item) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/60 to-transparent translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                <div className="text-white/70 text-xs mb-0.5">{item.category}</div>
          ...
          >
            ...
            >
              <div className="text-center text-white/50">
                ...
                <div className="text-lg font-semibold text-white">{lightbox.title}</div>
